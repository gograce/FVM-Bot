...
const decryptAndVerifySignature = async ({ cipherText, encryptedSecretKey, privateKeyArmored }) => {
...
export const decryptConversation = async ({ messages, connectedUser, pgpPrivateKey, env }) => {
  let otherPeer;
